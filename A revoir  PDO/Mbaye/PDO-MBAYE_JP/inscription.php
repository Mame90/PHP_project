	...
	if(isset($_GET['inscrire']))
	{
		...
		else
		{
			...
			//les deux mots de passe sont identiques
			{
				...
				/*$sel = "select logi from compte where logi='".$login."'";
